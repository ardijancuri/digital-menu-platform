...
Tremol.FP.prototype.timeStamp = 2508251400;
/**
...
/**
 * Prints QR 2D code
 * @param {string} Scale 1 symbol for scale
 * @param {string} CodeData From 0 to 200 bytes
 */
Tremol.FP.prototype.Print2DBarcode = function (Scale, CodeData) {
	return this.do('Print2DBarcode', 'Scale', Scale, 'CodeData', CodeData);
};
 ...
 * @param {Tremol.Enums.OptionCentering=} OptionCentering 1 symbol with possible values: 
 - '0' - No 
 - '1' - Yes
 */
Tremol.FP.prototype.PrintBarcode = function (OptionCodeType, CodeLen, CodeData, OptionCentering) {
	return this.do('PrintBarcode', 'OptionCodeType', OptionCodeType, 'CodeLen', CodeLen, 'CodeData', CodeData, 'OptionCentering', OptionCentering);
};
 ...
 * @param {number} ZrepNum 4 symbols for Z report number in format ####
 * @param {number} StartReceiptNum 6 symbols for initial receipt number in format ######
 * @param {number} EndReceiptNum 6 symbols for final receipt number in format ######
 */
 ...
 * @param {string} Text TextLength-2 symbols
 */
Tremol.FP.prototype.PrintTextBuffred = function (Text) {
	return this.do('PrintTextBuffred', 'Text', Text);
};
 ...
 * @param {Tremol.Enums.OptionExternalDispManagement} OptionExternalDispManagement 1 symbol of value: 
 - '1' - Manual 
 - '0' - Auto
 * @param {Tremol.Enums.OptionReceiptSend} OptionReceiptSend 1 symbol of value: 
 - '1' - Automatic sending 
 - '0' - Without sending
 ...
 * @param {Tremol.Enums.OptionWorkOperatorCount} OptionWorkOperatorCount 1 symbol of value: 
 ...
 - '0' - More
 */
Tremol.FP.prototype.ProgParameters = function (POSNum, OptionPrintLogo, OptionAutoOpenDrawer, OptionAutoCut, OptionExternalDispManagement, OptionReceiptSend, OptionEnableCurrency, OptionWorkOperatorCount) {
	return this.do('ProgParameters', 'POSNum', POSNum, 'OptionPrintLogo', OptionPrintLogo, 'OptionAutoOpenDrawer', OptionAutoOpenDrawer, 'OptionAutoCut', OptionAutoCut, 'OptionExternalDispManagement', OptionExternalDispManagement, 'OptionReceiptSend', OptionReceiptSend, 'OptionEnableCurrency', OptionEnableCurrency, 'OptionWorkOperatorCount', OptionWorkOperatorCount);
};
...
/**
 * @typedef {Object} KeyServerAddressRes
 * @property {number} ParamLength Up to 3 symbols for parameter length
 * @property {string} Address 60 symbols for address
 */

/**
 * Provides key for server address.
 * @return {KeyServerAddressRes}
 */
Tremol.FP.prototype.ReadKeyServerAddress = function () {
	return this.do('ReadKeyServerAddress');
};
 ...
 * @property {Tremol.Enums.OptionExternalDispManagement} OptionExternalDispManagement (External Display Management) 1 symbol of value: 
 - '1' - Manual 
 - '0' - Auto
 * @property {Tremol.Enums.OptionReceiptSend} OptionReceiptSend 1 symbol of value: 
- '1' - Automatic sending 
- '0' - Without sending
...
/**
 * @typedef {Object} RegisterServerAddressRes
 * @property {number} ParamLength Up to 3 symbols for parameter length
 * @property {string} Address 60 symbols for address
 */
 ...
 * @return {RegisterServerAddressRes}
 */
Tremol.FP.prototype.ReadRegisterServerAddress = function () {
	return this.do('ReadRegisterServerAddress');
};
 ...
 */
Tremol.FP.prototype.ReceivedOnAccount_PaidOut = function (OperNum, OperPass, Amount) {
	return this.do('ReceivedOnAccount_PaidOut', 'OperNum', OperNum, 'OperPass', OperPass, 'Amount', Amount);
};
...
/**
 * Select type of display
 * @param {Tremol.Enums.OptionExternalDisplay} OptionExternalDisplay 1 symbol:  
-'1' - Tremol display 
-'0' - Others
 */
 ...
 * @param {string} Address 60 symbols for address
 */
Tremol.FP.prototype.SetFiscalServerAddress = function (ParamLength, Address) {
	return this.do('SetFiscalServerAddress', 'ParamLength', ParamLength, 'Address', Address);
};
 ...
 * @param {string} Address 60 symbols for address
 */
Tremol.FP.prototype.SetRegisterServerAddress = function (ParamLength, Address) {
	return this.do('SetRegisterServerAddress', 'ParamLength', ParamLength, 'Address', Address);
};
 ...
 * @param {string} Address 60 symbols for address
 */
Tremol.FP.prototype.SetServerAddress = function (ParamLength, Address) {
	return this.do('SetServerAddress', 'ParamLength', ParamLength, 'Address', Address);
};
...
Tremol.Enums = Tremol.Enums || {
	...
	/**
	 * @typedef {Tremol.Enums.OptionCentering} Tremol.Enums.OptionCentering
	 * @readonly
	 * @enum
	 */
	OptionCentering: {
	...
	/**
	 * @typedef {Tremol.Enums.OptionReceiptSend} Tremol.Enums.OptionReceiptSend
	 * @readonly
	 * @enum
	 */
	OptionReceiptSend: {
