                ...
                <div className="container">
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' }}>
                        <div className="feature-card">
                            <div style={{ width: '100%', height: '200px', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '16px', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '3rem' }}>
                                🍕
                            </div>
                            <h3 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.75rem' }}>Italian Restaurant</h3>
                            <p style={{ color: '#666', lineHeight: '1.6', marginBottom: '1.5rem' }}>
                                Classic Italian menu with pasta, pizza, and wine selections. Features high-quality food photography and elegant typography.
                            </p>
                        ...
                        <div className="feature-card">
                            <div style={{ width: '100%', height: '200px', background: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', borderRadius: '16px', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '3rem' }}>
                                ☕
                            </div>
                            <h3 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.75rem' }}>Coffee Shop</h3>
                            <p style={{ color: '#666', lineHeight: '1.6', marginBottom: '1.5rem' }}>
                                Modern coffee shop menu featuring specialty drinks, pastries, and breakfast items with minimalist design.
                            </p>
                            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                        ...
                        <div className="feature-card">
                            <div style={{ width: '100%', height: '200px', background: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)', borderRadius: '16px', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '3rem' }}>
                                🍣
                            </div>
                            <h3 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.75rem' }}>Sushi Bar</h3>
                            <p style={{ color: '#666', lineHeight: '1.6', marginBottom: '1.5rem' }}>
                                Japanese restaurant menu with sushi rolls, sashimi, and traditional dishes. Includes dietary labels and allergen information.
                            </p>
                            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                        ...
                        <div className="feature-card">
                            <div style={{ width: '100%', height: '200px', background: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)', borderRadius: '16px', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '3rem' }}>
                                🍔
                            </div>
                            <h3 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.75rem' }}>Burger Joint</h3>
                            <p style={{ color: '#666', lineHeight: '1.6', marginBottom: '1.5rem' }}>
                                Casual burger restaurant with build-your-own options, sides, and craft beverages. Bold colors and playful design.
                            </p>
                            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                        ...
                        <div className="feature-card">
                            <div style={{ width: '100%', height: '200px', background: 'linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)', borderRadius: '16px', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '3rem' }}>
                                🥗
                            </div>
                            <h3 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.75rem' }}>Healthy Cafe</h3>
                            <p style={{ color: '#666', lineHeight: '1.6', marginBottom: '1.5rem' }}>
                                Health-focused menu with salads, smoothies, and organic options. Features nutritional information and vegan labels.
                            </p>
                            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                        ...
                        <div className="feature-card">
                            <div style={{ width: '100%', height: '200px', background: 'linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%)', borderRadius: '16px', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '3rem' }}>
                                🍷
                            </div>
                            <h3 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.75rem' }}>Wine Bar</h3>
                            <p style={{ color: '#666', lineHeight: '1.6', marginBottom: '1.5rem' }}>
                                Sophisticated wine list with detailed descriptions, pairings, and small plates. Elegant and refined design.
                            </p>
                            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                ...
                <div className="container">
                    <div style={{ textAlign: 'center', maxWidth: '600px', margin: '0 auto' }}>
                        ...
                        <p className="body-lg" style={{ marginBottom: '2rem' }}>
                            Start building your custom menu today
                        </p>
